...
const Team = () => {
    return (
        <div className='mx-20'>
            <h2 className='team-h2 my-5'>Our Team</h2>
            <div className='flex gap-5'>
                <div>
                    <img src={img1} alt="" className='relative' />
                    <div className='bg-[#24316B] text-white w-56 h-96 absolute -mt-[414.7px]'>
                        <h2 className='text-3xl font-bold pt-10 pl-6'>Nothing you wear is more important than your smile.</h2>
                        <h2 className='pl-6 pt-10 text-xl font-semibold'>MD AL MANSUR RAHMAN</h2>
                    </div>
                </div>
                <div>
