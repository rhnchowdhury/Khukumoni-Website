        ...
        <div className='lg:my-8 my-5'>
            <div className="lg:mx-20">
                <div className="hero-content flex-col lg:flex-row ">
                    <div>
                        <h1 className='lg:text-5xl text-4xl font-bold text-[#24316B]'>Food For All</h1>
                ...
                <p className='food-sec-p mt-5'>Bangladesh has been facing a huge deficit of food which compelled people to suffer unconditionally. As poverty is engaged inextricably with our country, so the mistress of the poor community is a beggar description. People from different professionals like ricksha puller, van scooter, cleaners, brick mill workers, barbers, the delivery person, and even farm workers are also suffering from the food crisis. Under these circumstances, the COVID-19 pandemic also brings extraneous poverty and food crisis. Peoples are becoming jobless and losing their income sources.
