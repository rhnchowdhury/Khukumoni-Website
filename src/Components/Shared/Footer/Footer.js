    ...
    return (
        <div className='mt-8'>
            <div className="relative  bg-[#18214E] w-full h-[430px] overflow-hidden text-left text-sm text-white ">
                <div className="absolute top-[405px] left-[635px] w-[171px] h-4 text-md">
                    <div className="absolute top-[6.25%] left-[0%] font-light">
                        © 2023 All Rights Reserved
                    </div>
                </div>
                <div className="absolute top-[380px] left-[453px] flex flex-row items-start justify-start gap-[40px] font-medium">
                ...
                <div className="absolute top-[230px] left-[622px] w-[251px] h-[38px]">
                ...
                <div className="absolute top-[290px] left-[622px] w-[186px] h-6">
                ...
                <b className="absolute top-[210px] left-[622px] text-[18px]">Contact Us</b>
                <div className="absolute top-[330px] left-[622px] rounded-md bg-white shadow-[0px_4px_6px_-4px_rgba(24,_39,_75,_0.12),_0px_8px_8px_-4px_rgba(24,_39,_75,_0.08)] box-border w-[150px] h-[30px] flex flex-row items-center justify-center py-[5px] px-[26px] text-center text-base text-black border-[1px] border-solid border-white">
                ...
                <div className="absolute h-[68.71%] w-[25.97%] top-[18.14%] right-[66.18%] bottom-[18.14%] left-[3.85%] text-lg">
                ...
                <img src={logo} alt="" className="absolute top-[50px] left-[623px] w-[150px] h-[160px] overflow-hidden" />
                ...
                <div className="absolute top-[270px] left-[1060px] w-[250px]  text-[20px]">
